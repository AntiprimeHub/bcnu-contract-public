...
| [^bcfiscal] | **BC Budget — Budget and Fiscal Plan (three-year)**, bcbudget.gov.bc.ca | BC budgets on a rolling three-year fiscal plan; labour compensation is the single largest government cost — the multi-year-planning basis for §1.4. |
| [^scchealth] | **Health Services and Support – Facilities Subsector Bargaining Assn. v. British Columbia, 2007 SCC 27** ([2007] 2 SCR 391), canlii.org | SCC struck down parts of the 2002 *Health and Social Services Delivery Improvement Act* (Bill 29) that voided collective-agreement terms; Charter s. 2(d) protects a meaningful process of collective bargaining. |
| [^sccbctf] | **British Columbia Teachers' Federation v. British Columbia, 2016 SCC 49**, canlii.org | SCC (from the bench) voided the teacher-contract provisions of the 2012 *Education Improvement Act* (Bill 22) on the same s. 2(d) basis. |
...
The practical consequence is that the wage *number* is largely pre-set and pre-funded, so a union's real bargaining room is on **non-wage structure** (premiums, benefits, staffing, workload) — though the 2025 NCI model now sweeps much of that into the comparison too (§5.7). *(This describes the normal negotiated path; where bargaining fails, the province's fallbacks are mediation or, rarely, back-to-work / imposed legislation — see §1.4.)*

### 1.4 How a four-year commitment survives annual budgets

A multi-year mandate raises an obvious tension: government budgets are struck **annually**, but the agreement locks in increases for four years. Three things keep the funding from evaporating when a later budget tightens.

1. **It is a binding contract, not an annual line item.** Once ratified, the increases are terms of a collective agreement enforceable under the Labour Relations Code. A leaner budget in a later year does not release the obligation — underpayment would be a grievable, arbitrable breach. The yearly appropriation that the Legislature votes is the *mechanism* that pays a binding obligation, not a fresh vote on whether to honour it.
2. **It is planned on a multi-year horizon.** BC budgets on a rolling **three-year Budget and Fiscal Plan**, not one year at a time, and labour compensation is the single largest line in it.[^bcfiscal] The PSEC mandate is costed against that plan *before* it is issued — the point of "aligning compensation costs with the fiscal plan" (§1.3) — and each annual budget rolls the plan forward, re-confirming the mandate's cost. (Because the mandate runs four years and each fiscal-plan window is three, the final year is picked up as the plan rolls forward.)
3. **Mid-term override is constitutionally fenced.** The only way a government can actually cancel a ratified increase is to **legislate over the contract** — and BC has twice been told it cannot do so freely. In *Health Services* (2007) the Supreme Court of Canada struck down parts of the 2002 *Health and Social Services Delivery Improvement Act* ("Bill 29") that had voided health-sector collective-agreement terms, holding that **Charter s. 2(d) protects a meaningful process of collective bargaining**.[^scchealth] In *BCTF* (2016), ruling from the bench, the Court voided the teacher-contract provisions of the 2012 *Education Improvement Act* ("Bill 22") on the same basis.[^sccbctf]

So the durable protection across the term is **contract law plus the constitution**, not the annual budget: the 3%/year is a binding, multi-year, pre-costed obligation; the yearly appropriation pays it rather than re-decides it; and the one real off-ramp — legislative override — is now constitutionally constrained. The mandate's design (capping the envelope to fit the fiscal plan, §1.3) is precisely what keeps government from ever needing that off-ramp.
...
[^bcfiscal]: BC Budget — *Budget and Fiscal Plan* (a rolling three-year fiscal plan; labour compensation is the single largest government cost): https://www.bcbudget.gov.bc.ca/ (e.g. *Budget and Fiscal Plan 2025/26–2027/28*: https://www.bcbudget.gov.bc.ca/2025/pdf/2025_budget_and_fiscal_plan.pdf)
[^scchealth]: *Health Services and Support – Facilities Subsector Bargaining Assn. v. British Columbia*, 2007 SCC 27, [2007] 2 SCR 391: https://www.canlii.org/en/ca/scc/doc/2007/2007scc27/2007scc27.html (struck down ss. 6(2), 6(4), 9 of the *Health and Social Services Delivery Improvement Act*, SBC 2002, c. 2 / "Bill 29" as infringing Charter s. 2(d))
[^sccbctf]: *British Columbia Teachers' Federation v. British Columbia*, 2016 SCC 49 (decided from the bench, 10 Nov 2016): https://www.canlii.org/en/ca/scc/doc/2016/2016scc49/2016scc49.html (restored teacher collective-agreement terms voided by the *Education Improvement Act*, SBC 2012, c. 3 / "Bill 22")
